...
void antecedentes_lista(){
    ...
    strcpy(acolito.ideal[0],"As tradições ancestrais de adoraçãoo e sacrifício devem ser preservadas e perpetradas. (Leal)");
    ...
    strcpy(acolito.vinculo[5],"Eu busco guardar um texto sagrado que meus inimigos dizem ser her�tico e tentam destruí-lo.");

    strcpy(acolito.defeito[0],"Eu julgo os outros severamente, e a mim mesmo mais ainda.");
    strcpy(acolito.defeito[1],"Eu deposito muita confiança naqueles que detém o poder na hierarquia de meu templo.");
    strcpy(acolito.defeito[2],"Minha devoção é muitas vezes me cega perante aqueles que professam a fé do meu deus.");
    strcpy(acolito.defeito[3],"Meu pensamento é inflex�vel.");
    ...
    strcpy(artesao.ideal[0],"É dever de todo cidadão civilizado fortalecer os elos da comunidade e a segurança da civiliza��o. (Leal)");
